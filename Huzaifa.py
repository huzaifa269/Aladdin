...
def login():
	...
	try:
      ...
      jalan(' \033[1;31m--->DO NOT USER REAL ACCOUNT')
      jalan(' \033[1;31m--->USE A FRESH ACCOUNT')
      jalan(' \033[1;31m--->KEEP REMEMBER IN PRAYERS')
      jalan(' \033[1;31m--->DO NOT EDIT MY SCRIPT')
      jalan(' \033[1;31m--->LETS START')
		jalan(' \033[1;97m--------------------------------------------------')
